...
> 스택오버플로우, 유튜브, 유데미, egghead, frontend masters, nomad coder, twitter
...
### 상태관리에 reducer 사용한 이유

### 좋은 코드란? 유연한 코드란 무엇일까?

### 컴포넌트에서 옵셔널로하면 비대해지지않나?

### 이 회사가 뭘 하는 회사인지는 알고 지원했나?

### 변화가 빠른 생태계에서 프레임워크를 익히는 방법

### 기술공유에 대해 선호하는 편인지

### 새롭게 공부하고 있는 기술적인 부분

### map reduce filter 사용 구현

### sum(1)(2)() 함수 구현

### 쿼리스트링 객체로 변환 <-> 객체 쿼리스트링으로 변환

### 클릭 시 애니메이션 이벤트

### 프론트 성능관련 한 노력?

### 코드리뷰 시 선배 개발자와 갈등이 생긴 경우
